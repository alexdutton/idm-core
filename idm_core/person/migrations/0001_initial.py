...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Person',
            fields=[
                ('id', models.UUIDField(default=idm_core.person.models.get_uuid, editable=False, primary_key=True, serialize=False)),
                ...
                ('merged_into', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='person.Person')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid', models.UUIDField(default=idm_core.person.models.get_uuid, editable=False, primary_key=True, serialize=False)),
